  ...
  return (
    <TabsPrimitive.Tab
      className={cn(
        ...
        "data-active:border-white/3 data-active:bg-background data-active:text-foreground dark:data-active:border-white/3 dark:data-active:bg-input/30 dark:data-active:text-foreground",
